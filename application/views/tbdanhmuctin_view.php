...
<html lang="en">
<head>
	<title>Thất bại - Danh mục tin </title>
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="1;url= <?= base_url() ?>Tintuc/danhmuctin">
...
<body>
	<div class="container">
		<div class="alert alert-danger mt-4" role="alert">
			<strong>THẤT BẠI</strong> You successfully read this important alert message.
		</div>
	</div>
