...
<html lang="en">
<head>
	<title> Thành công - Tin </title>
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="1;url= <?= base_url() ?>Tintuc/quanlytintuc">
...
<body>
	<div class="container">
		<div class="alert alert-success mt-4" role="alert">
			<strong>THÀNH CÔNG</strong> You successfully read this important alert message.
		</div>
	</div>
