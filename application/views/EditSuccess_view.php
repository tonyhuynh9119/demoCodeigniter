...
<html lang="en">
<head>
	<title> Success - JSON </title>
	<meta charset="UTF-8">
	<meta http-equiv="refresh" content="1;url= <?= base_url() ?>Do_edit">
...
<body>
	<div class="container">
		<div class="alert alert-success mt-4" role="alert">
			<strong>Edit Success</strong> You successfully read this important alert message.
		</div>
	</div>
